            ...
            if (!userId.Equals(string.Empty))
            {
                ...
                if (!context.Modules.Any())
                {
                    var modules = new List<Module>
                    {
                        new Module
                        {
                            Course = context.Find<Course>(courseId1), Title = "Module 1"
                        },
                        new Module
                        {
                            Course = context.Find<Course>(courseId1), Title = "Module 2"
                        },
                        new Module
                        {
                            Course = context.Find<Course>(courseId2), Title = "Module 3"
                        }
                    };
                ...
                if (!context.Downloads.Any())
                {
                    var downloads = new List<Download>
                    {
                        ...
                        new Download
                        {
                            ModuleId = moduleId2, CourseId = courseId2,
                            Title = "ADO.NET 1 (PDF)", Url = "https://some-url"
                        }
                    };
